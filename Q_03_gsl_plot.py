...
# -*- coding: utf-8 -*-
"""
Created on Tue May 19 23:13:35 2020
...
''' actually this is importing the file, where the data of FT of this function
        is stored by running the c code using gsl library .
         Now we can plot this to check with the numpy.fft.fft'''
file =  "/home/jaga/Desktop/com_phy_assgts/assgt3/Q_03_import_data.txt" 
freq , FT_real , FT_imag = np.loadtxt(file, usecols = (0,1,2) ,unpack = "true")
plt.plot( freq , FT_real ,label = 'Real Part (Using gsl)' , marker = '*', color = 'black')
plt.plot( freq , FT_imag ,label = 'Imaginary Part (Using gsl)')
